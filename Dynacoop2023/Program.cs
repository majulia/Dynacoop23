...
namespace Dynacoop2023
{
    internal class Program
    {
        ...
        private static void MakeCreateAndUpdate(ContaController contaController)
        {
            ...
            Console.WriteLine($"https://orgc9746b6b.crm2.dynamics.com/main.aspx?appid=4d306bb3-f4a9-ed11-9885-000d3a888f48&pagetype=entityrecord&etn=account&id={accountId}");
